...
<body>
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            var targetSlide = $('.slider-nav .slick-slider[data-post-id="' + currentPostId + '"]').closest('.slick-slide');
            ...
            if (targetSlide.length) {
                ...
                $('.slider-nav').slick('slickGoTo', targetIndex);
            } else {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            if (!modelUrl || modelUrl === 'false') {
                ...
                //     // Set Dynamic Zoom Based on Screen Size
                //     const maxDimension = Math.max(size.x, size.y, size.z);
                //     let idealDistance = maxDimension * 2; // Default for desktop

                //     if (window.innerWidth < 768) { 
                //         // 📱 Adjust for mobile (if screen width < 768px)
                //         idealDistance = maxDimension * 4; // Zoom out more on mobile
                //     }

                //     camera.position.set(0, 0, idealDistance);
                //     controls.minDistance = idealDistance * 0.8; // Minimum zoom
                //     controls.maxDistance = idealDistance * 2; // Maximum zoom
                //     controls.update();
